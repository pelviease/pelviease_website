...
class _TestimonialsSectionState extends State<TestimonialsSection> {
  final List<Map<String, String>> testimonials = [
    ...
    {
      'quote': "This product is a game-changer! I feel more energetic and balanced.",
      'author': 'Sneha P., 31',
    },
    {
        ...
        children: [
          ...
          if(isMobile)
            Positioned(
              ...
              child: Text("Testimonials", style: Theme.of(context).textTheme.titleLarge?.copyWith(
                fontSize: 32,
                color: darkViolet
              ),),
            ),
          ...
          Positioned(
            top: 50,
            left: isMobile ? MediaQuery.of(context).size.width * 0.5 - 170 : MediaQuery.of(context).size.width * 0.3 - 250,
            child: Container(
              height: 400,
              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.format_quote, color: Colors.white, size: isMobile ? 32 : 48),
